...
public class PhoBienAdapter extends BaseAdapter {
    Context context;
    int layout;
    List<sanpham> phobienList;

    public PhoBienAdapter(Context context, int layout, List<sanpham> phobienList) {
    ...
    public Object getItem(int i) {
        return phobienList.get(i);
    }

    @Override
    public long getItemId(int i) {
        return phobienList.get(i).getId();
    }
...
public class viewholder{
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        sanpham pb = phobienList.get(position);
